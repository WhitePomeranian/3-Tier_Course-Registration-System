    ...
    <div class="content">
        <div class="left_content">
            ...
            <fieldset>
				...
				%>
				<label id="ID" for="student_id">學號: <% out.println(user_id); %></label>
				<br>
				<br>
        ...
        <div class="right_content">
            ...
            <fieldset>
            	<legend>查詢課程</legend>
            	<form id="section_form" action="user_interface2.jsp" method="post">
			...
			<fieldset>
				<legend>課程加選</legend>
				<form action="user_interface2.jsp" method="post">
			...
			<form id="course_table" action="user_interface2.jsp" method="post">
